package com.udfex.ams.module.schedule.service;

import com.udfex.ams.module.schedule.QuartzManager;
import com.udfex.ams.module.schedule.controller.vo.ScheduleJobVo;
import com.udfex.ams.module.schedule.controller.vo.UpdateQuartzJob;
...
public class ScheduleJobService {
    ...
    public Page<ScheduleJobVo> queryScheduleJobs(String keyword, Integer pageSize, Integer pageNum){
        ...
        return (Page<ScheduleJobVo>) mybatisDao.selectPage("com.udfex.ams.schedule.mapper.ScheduleMapper.queryScheduleJobs", string, pageSize, pageNum);
    }
